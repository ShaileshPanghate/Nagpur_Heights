...
const Employee = () => {
  ...
  const [formData, setFormData] = useState({
    name: '', email: '', phone: '', position: '', department: '', joiningDate: ''
  });
  ...
  const handleAddOrUpdate = () => {
    ...
    setFormData({ name: '', email: '', phone: '', position: '', department: '', joiningDate: '' });
    setIsEditing(false);
    setEditIndex(null);
    setShowModal(false);
  };
  ...
  return (
    <div className="employee-container">
      <div className="filters">
        <button className='newBtn' onClick={() => { setShowModal(true); setIsEditing(false); setFormData({ name: '', email: '', phone: '', position: '', department: '', joiningDate: '' }); }}>
          + Add Employee
        </button>
        ...
        <table className="employee-table">
          <thead>
            <tr>
              ...
              <th>POSITION</th><th>DEPARTMENT</th><th>JOINING DATE</th><th>ACTIONS</th>
            </tr>
          </thead>
          <tbody>
            {paginatedEmployees.length === 0 ? (
              <tr><td colSpan="7" className="no-data">No employee data found.</td></tr>
            ) : (
        ...
        {showModal && (
          <div className="modal-overlay">
            <div className="modal">
              ...
              <input type="date" name="joiningDate" placeholder="Joining Date" value={formData.joiningDate} onChange={handleInputChange} />
